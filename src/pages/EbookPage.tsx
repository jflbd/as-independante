...
const EbookPage: React.FC = () => {
    ...
    // Lien de retour à l'accueil avec style fixe (toujours visible)
    const HomeButton = () => (
        <button
            onClick={() => navigate('/')}
            className="fixed z-30 top-24 left-6 bg-white/90 hover:bg-primary text-primary hover:text-white flex items-center gap-1 px-3 py-2 rounded-full shadow-lg hover:shadow-xl transition-all border border-primary/20"
    ...
    return (
        <div className="ebook-page bg-gray-50">
            ...
            {/* Bouton de retour à l'accueil fixe */}
            <HomeButton />
            ...
            <main className="pb-16">
                ...
                {/* Section témoignages */}
                <section id="temoignages" className="py-16 bg-gray-50 scroll-mt-16">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div 
                                    className="testimonial-card bg-white p-6 relative rounded-lg shadow-sm hover:shadow-md transition-shadow"
                                    key={index}
                                >
                                    {/* Guillemet décoratif */}
                        ...
                        <div className="mt-12">
                            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12">
                                <div className="bg-white px-6 py-3 rounded-full shadow-sm flex items-center hover:shadow-md transition-shadow">
