    ...
    <>
      <section id="services" className="py-12 md:py-16 bg-white" aria-labelledby="services-title">
        <div className="container px-4 mx-auto">
          ...
          {/* Particuliers */}
          <div className="mb-16">
            <article className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow animate-fade-up max-w-5xl mx-auto">
              <div className="p-6 md:p-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
                    {services[0].scenarios.map((scenario, idx) => (
            ...
            <article className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow animate-fade-up max-w-5xl mx-auto">
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-8 mb-6">
                  {services[1].companies.map((company, idx) => (
