...
const defaultEnvVars = {
  ...
  'VITE_APP_KEYWORDS': 'assistante sociale, Normandie, accompagnement social, démarches administratives',
...
let envContent = '# Fichier .env.production généré automatiquement pour le déploiement Vercel\n';
